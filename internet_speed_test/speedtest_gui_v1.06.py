"""
Speed Test GUI Application v1.06
================================================================================
...
class SpeedTestApp:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Speed Test Application v1.06 - Cloudflare")
    ...
    def show_speed_graph(self):
        ...
        graph_window.title("Speed Log Graph v1.06")
    ...
    def build_cloudflare_request(self, path, params=None, data=None, method=None):
        ...
        headers = {
            "User-Agent": (
                ...
                "Chrome/125.0 Safari/537.36 SpeedTestGUI/1.06"
            ),
