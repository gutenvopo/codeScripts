...
class FishboneDiagram:
    def __init__(self):
        self.problem = "Problem to be Solved / Effect"
...
class FishboneApp(tk.Tk):
    ...
    def _set_problem(self):
        self.model.problem = self.prob_var.get() or "Problem to be Solved / Effect"; self._draw()
    ...
    def _reset_diagram(self):
        if messagebox.askyesno("Reset Diagram", "Reset to the default example diagram?", parent=self):
            ...
            self.model.problem = "Problem to be Solved / Effect"
